...
func (c *remotingServiceClient) RemoteSendSync(ctx context.Context, in *RemoteSendSyncRequest, opts ...grpc.CallOption) (*RemoteSendSyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/actors.v1.RemotingService/RemoteSendSync", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remotingServiceClient) RemoteSendAsync(ctx context.Context, in *RemoteSendAsyncRequest, opts ...grpc.CallOption) (*RemoteSendAsyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/actors.v1.RemotingService/RemoteSendAsync", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remotingServiceClient) RemoteLookup(ctx context.Context, in *RemoteLookupRequest, opts ...grpc.CallOption) (*RemoteLookupResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/actors.v1.RemotingService/RemoteLookup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RemotingService_RemoteSendSync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/actors.v1.RemotingService/RemoteSendSync",
	}
...
func _RemotingService_RemoteSendAsync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/actors.v1.RemotingService/RemoteSendAsync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RemotingService_RemoteLookup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/actors.v1.RemotingService/RemoteLookup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
